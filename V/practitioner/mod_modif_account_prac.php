...
<body>
    ...
    <form action="index.php" method="GET">
        email : <input type="text" name="emails" pattern="[A-z0-9._%+-]+@[a-z0-9.-]+[.][a-z]{2,3}$" value="<?php echo $data['email']?>" required><br>
        ...
        adrs : <input type="text" name="adrs" required value="<?php echo $data['adrs']?>"><br>
